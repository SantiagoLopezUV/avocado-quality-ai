        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-[0px] py-[8px]">
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden md:flex gap-8">
              ...
              {user && (
                <button onClick={() => navigate("/batches")} className="text-lg text-gray-900 dark:text-gray-100 hover:text-[#8bc34a] dark:hover:text-[#9ccc65] font-medium transition-colors">
                  Mis Lotes
                </button>
              )}
              {user ? (
